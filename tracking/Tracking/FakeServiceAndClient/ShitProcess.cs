...
namespace FakeServiceAndClient
{
    ...
    class ShitProcess: System.Activities.Activity, System.ComponentModel.ISupportInitialize 
    {
        ...
        private string FindResource() {
            ...
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                ...
                if ((resource.Contains(".SESampleProcess2.g.xaml") || resource.Equals("SESampleProcess2.g.xaml"))) {
                    return resource;
                }
            }

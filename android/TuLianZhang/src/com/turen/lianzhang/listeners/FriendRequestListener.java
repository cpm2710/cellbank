...
import com.turen.lianzhang.renren.FriendHandler;
import com.turen.lianzhang.renren.RestSaxParser;
...
public class FriendRequestListener extends DefaultRequestListener {
    ...
    public FriendRequestListener(Main example, String dataFormate) {

...
// cette classe ex�cutre la r�gle "Rule-2" dans le projet local dans prot�g� "ontologieK.pprj"
public class MonitoringMain extends JPanel    implements ActionListener { 
	...
	// Le constructeur initialise les composants graphiques n�cessaires pour l'affichage
	...
	// gestion des �v�nements graphiques (openOWLFile et startMonitoring)
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
				...
				try{
					...
					else
					{
						...
						// cr�er une instance de SWRLFactory qui sera responsable de la gestion des r�gles SWRL (activation, d�sactivation, cr�ation, suppression...)
						factory = new SWRLFactory(owlModel);
						// cr�er une instance de SWRLRuleEngineBridge qui sera responsable de l'ex�cution des r�gles et de la r�cup�ration du r�sultat de cette ex�cution
	...
	/*
	Cette m�tode r�cup�re les d�tails (le nom de la m�trique et sa fr�quence de mesure) de toutes les m�triques d�finies dans l'ontologie. 
	Pour chaque m�trique, on cr�� une r�gle SWRL qui permet de r�cup�rer sa mesure et nous instancions un MetricMeasurementService.
	*/
	private void createMetricMeasurementServices()
	{
			...
			while (result.hasNext()) {
				...
				catch(Exception e){/*ici �a veut dire que la r�gle existe d�ja*/log.append(e.getMessage());}
	...
	/*
	Cette m�tode r�cup�re les d�tails (le nom du SLaparameter et sa fr�quence d'agr�gation)  de tous les SLAparameter d�finis dans l'ontologie. 
	Pour chaque SLAparameter, on cr�� une r�gle SWRL qui permet de calculer sa valeur et nous instancions un SLAParameterMeasurementService.
	*/
	private void createSLAParameterMeasurementServices()
	{
			...
			while (result.hasNext()) {
				...
				catch(Exception e){/*ici �a veut dire que la r�gle existe d�ja*/}
	...
	/*
	Cette m�tode r�cup�re les d�tails (le nom de la r�gle SWRL et sa fr�quence de v�rification)  de tous les pr�dicats d�finis dans l'ontologie. 
	Pour chaque pr�dicat, nous instancions un ObligationMonitoringService.
	*/

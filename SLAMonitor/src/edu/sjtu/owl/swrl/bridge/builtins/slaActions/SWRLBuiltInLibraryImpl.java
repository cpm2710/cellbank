...
import edu.stanford.smi.protegex.owl.model.*;
   ...
   public SWRLBuiltInLibraryImpl() 
	...
	// ici la mesure de la m�trique est simul�e par une g�n�ration d'un float entre 0 et 170. Ceci doit �tre remplac?par l'appel de la directive de mesure
	...
	// affecter au deuxi�me argument la valeur du r�sultat
	if (arguments.size()>1)
	...
	try{
		Function function = (Function) Class.forName(agregationFunction).newInstance();
			// affecter au troisi�me argument la valeur du r�sultat
		if (arguments.size()>2)
	 ...
	 public boolean disseminateViolation(List<Argument> arguments) throws BuiltInException
      {
		...
		JOptionPane.showMessageDialog(null,MESSAGE+"---");
			...
			rr3.start();		// cette m�thode peut �tre �tendue ?d'autres actions plus �labor�es qu'un simple affichage sur la console
        return true;

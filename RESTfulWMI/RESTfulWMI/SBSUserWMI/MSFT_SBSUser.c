...
void MI_CALL MSFT_SBSUser_Unload(
...
void MI_CALL MSFT_SBSUser_EnumerateInstances(
    _In_opt_ MSFT_SBSUser_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL MSFT_SBSUser_CreateInstance(
    _In_opt_ MSFT_SBSUser_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL MSFT_SBSUser_ModifyInstance(
    _In_opt_ MSFT_SBSUser_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL MSFT_SBSUser_DeleteInstance(
    _In_opt_ MSFT_SBSUser_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,

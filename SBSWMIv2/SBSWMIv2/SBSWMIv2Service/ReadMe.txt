========================================================================
    ACTIVE TEMPLATE LIBRARY : SBSWMIv2Service Project Overview
========================================================================

AppWizard has created this SBSWMIv2Service project for you to use as the starting point for
writing your Service (EXE).

This file contains a summary of what you will find in each of the files that
make up your project.

SBSWMIv2Service.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

SBSWMIv2Service.vcxproj.filters
...
SBSWMIv2Service.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (SBSWMIv2Service.h)
        GUID definitions                                (SBSWMIv2Service_i.c)
        A type library                                  (SBSWMIv2Service.tlb)
        Marshaling code                                 (SBSWMIv2Service_p.c and dlldata.c)

SBSWMIv2Service.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in SBSWMIv2Service.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named SBSWMIv2Service.pch and a precompiled types file named StdAfx.obj.
...
SBSWMIv2Serviceps.vcxproj
	...
	dlldata.c, SBSWMIv2Service_i.c and SBSWMIv2Service_p.c which are required
	to build the proxy/stub DLL.

SBSWMIv2Serviceps.vcxproj.filters

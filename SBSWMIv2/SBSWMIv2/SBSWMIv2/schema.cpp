...
static MI_CONST MI_Boolean MSFT_SBSUser_UserName_Key_qual_value = 1;

static MI_CONST MI_Qualifier MSFT_SBSUser_UserName_Key_qual =
{
    MI_T("Key"),
    MI_BOOLEAN,
    MI_FLAG_DISABLEOVERRIDE|MI_FLAG_TOSUBCLASS,
    &MSFT_SBSUser_UserName_Key_qual_value
};

static MI_CONST MI_Char* MSFT_SBSUser_UserName_Description_qual_value = MI_T("N/A");

static MI_CONST MI_Qualifier MSFT_SBSUser_UserName_Description_qual =
{
    MI_T("Description"),
    MI_STRING,
    MI_FLAG_ENABLEOVERRIDE|MI_FLAG_TOSUBCLASS|MI_FLAG_TRANSLATABLE,
    &MSFT_SBSUser_UserName_Description_qual_value
};

static MI_Qualifier MI_CONST* MI_CONST MSFT_SBSUser_UserName_quals[] =
{
    &MSFT_SBSUser_UserName_Key_qual,
    &MSFT_SBSUser_UserName_Description_qual,
};

/* property MSFT_SBSUser.UserName */
static MI_CONST MI_PropertyDecl MSFT_SBSUser_UserName_prop =
{
    MI_FLAG_PROPERTY|MI_FLAG_KEY|MI_FLAG_READONLY, /* flags */
    0x00756508, /* code */
    MI_T("UserName"), /* name */
    MSFT_SBSUser_UserName_quals, /* qualifiers */
    MI_COUNT(MSFT_SBSUser_UserName_quals), /* numQualifiers */
    MI_STRING, /* type */
    NULL, /* className */
    0, /* subscript */
    offsetof(MSFT_SBSUser, UserName), /* offset */
    MI_T("MSFT_SBSUser"), /* origin */
    MI_T("MSFT_SBSUser"), /* propagator */
    NULL,
};

/* property MSFT_SBSUser.PassWord */
static MI_CONST MI_PropertyDecl MSFT_SBSUser_PassWord_prop =
{
    ...
    NULL, /* className */
    0, /* subscript */
    offsetof(MSFT_SBSUser, PassWord), /* offset */
    MI_T("MSFT_SBSUser"), /* origin */
    MI_T("MSFT_SBSUser"), /* propagator */
    NULL,
};

static MI_PropertyDecl MI_CONST* MI_CONST MSFT_SBSUser_props[] =
{
    &MSFT_SBSUser_UserName_prop,
    &MSFT_SBSUser_PassWord_prop,
};

static MI_CONST MI_ProviderFT MSFT_SBSUser_funcs =
{
  (MI_ProviderFT_Load)MSFT_SBSUser_Load,
  (MI_ProviderFT_Unload)MSFT_SBSUser_Unload,
  (MI_ProviderFT_GetInstance)MSFT_SBSUser_GetInstance,
  (MI_ProviderFT_EnumerateInstances)MSFT_SBSUser_EnumerateInstances,
  (MI_ProviderFT_CreateInstance)MSFT_SBSUser_CreateInstance,
  (MI_ProviderFT_ModifyInstance)MSFT_SBSUser_ModifyInstance,
  (MI_ProviderFT_DeleteInstance)MSFT_SBSUser_DeleteInstance,
...
static MI_CONST MI_Char* MSFT_SBSUser_ClassVersion_qual_value = MI_T("1.0.0");

static MI_CONST MI_Qualifier MSFT_SBSUser_ClassVersion_qual =
{
    MI_T("ClassVersion"),
    MI_STRING,
    MI_FLAG_ENABLEOVERRIDE|MI_FLAG_RESTRICTED,
    &MSFT_SBSUser_ClassVersion_qual_value
};

static MI_Qualifier MI_CONST* MI_CONST MSFT_SBSUser_quals[] =
{
    &MSFT_SBSUser_ClassVersion_qual,
};

/* class MSFT_SBSUser */
MI_CONST MI_ClassDecl MSFT_SBSUser_rtti =
{
    MI_FLAG_CLASS, /* flags */
    0x006D720C, /* code */
    MI_T("MSFT_SBSUser"), /* name */
    MSFT_SBSUser_quals, /* qualifiers */
    MI_COUNT(MSFT_SBSUser_quals), /* numQualifiers */
    MSFT_SBSUser_props, /* properties */
    MI_COUNT(MSFT_SBSUser_props), /* numProperties */
    sizeof(MSFT_SBSUser), /* size */
    NULL, /* superClass */
    NULL, /* superClassDecl */
    NULL, /* methods */
    0, /* numMethods */
    &schemaDecl, /* schema */
    &MSFT_SBSUser_funcs, /* functions */
    NULL /* owningClass */
};

...
unsigned long long write_array[MAX_THREADS];
unsigned long long read_array[MAX_THREADS];
unsigned long long rewrite_array[MAX_THREADS];
unsigned long long comment_array[MAX_THREADS];

typedef struct indexFlag
{
	unsigned int index;
	unsigned int flag;
}indexFl, *ifp;
